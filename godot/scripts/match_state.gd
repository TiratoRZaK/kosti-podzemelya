...
const MODES := {
	"classic": {
		"title": "КЛАССИКА", "sub": "3 жизни · поле 3×2 · 6 ходов · обычно 4 раунда",
		"cols": 3, "cells": 6, "moves": 6, "kind": "lives", "deck": "per_round", "deck_size": 10,
		"komi": 0, "komi3": 0, "komi4": 0,
	},
	"big": {
		"title": "БОЛЬШАЯ ДОСКА", "sub": "3 жизни · поле 3×3 · 10 ходов · обычно 4 раунда",
	...
	"draft": {
		"title": "СВОЯ КОЛОДА", "sub": "сам набираешь колоду · у соперника та же · 3 раунда",
		"cols": 3, "cells": 6, "moves": 6, "kind": "bo3", "win_by": "score", "deck": "draft",
		"komi": 0, "komi3": 0, "komi4": 0,
	},
	"race": {
		"title": "ГОНКА ДО 500", "sub": "счёт копится · кто первым наберёт 500 · самый долгий режим",
	...
	"territory": {
		"title": "ТЕРРИТОРИЯ", "sub": "раунд берёт тот, кто дольше удерживал клетки · 3 раунда",
